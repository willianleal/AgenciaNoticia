    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => new { t.codMateria, t.codComentario })
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        codSessao = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.Secao", t => t.codSessao)
                ...
                c => new
                    {
                        ...
                        secao = c.String(nullable: false, maxLength: 50),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Materia", "codSessao", "dbo.Secao");
            ...
            DropIndex("dbo.Materia", new[] { "codSessao" });
